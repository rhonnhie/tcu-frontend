...
export const ChatPopUp = function ChatPopUp() {
  ...
  return (
    ...
    >
      <div
        className={`bg-white rounded shadow mb-20 w-[calc(100vw-2rem)] max-h-[calc(100vh-10rem)] lg:max-h-none lg:w-[380px] transition-transform ${
      ...
      >
        ...
        <section className='p-4 pb-0'>
          <div className='assistant-message-container text-sm lg:text-base max-h-[300px] lg:max-h-[35 0px]'>
            ...
            {isLoading && (
              <div className='mb-4' ref={lastMessageRef}>
                <p className='font-sans whitespace-pre-wrap p-4 bg-gray-700 text-white inline-block rounded-xl rounded-bl-none'>
                  Typing..
                </p>
              </div>
            )}
        ...
        >
          <textarea
            className='rounded grow max-h-60 resize-none text-sm lg:text-base'
            placeholder='Aa'
