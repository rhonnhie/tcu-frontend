...
export const EventUpdateForm = function EventUpdateForm(props) {
  const { event, close, mutate } = props;
  ...
  const onSubmit = handleSubmit(async (formData) => {
    ...
    const values = {
      ...
      date_of_event: formData.date_of_event
        ? new Date(formData.date_of_event).toJSON()
        : void 0,
      attachments,
    };
      ...
      >
        ...
        <div className='mt-4'>
          ...
          <input
            ...
            title='Date of event'
            id='event_date'
            defaultValue={moment(event?.date_of_event).format('YYYY-MM-DD')}
